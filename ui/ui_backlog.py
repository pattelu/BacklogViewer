...
class Ui_Backlog(object):
    def setupUi(self, Backlog):
        ...
        Backlog.setMaximumSize(QSize(16777215, 16777215))
        Backlog.setAcceptDrops(True)
        ...
        self.tab_game.setAcceptDrops(True)
        ...
        self.table_game.setAcceptDrops(True)
        self.table_game.setEditTriggers(QAbstractItemView.EditTrigger.DoubleClicked|QAbstractItemView.EditTrigger.EditKeyPressed)
        self.table_game.setDragEnabled(True)
        self.table_game.setDragDropMode(QAbstractItemView.DragDropMode.DropOnly)
        self.table_game.setDefaultDropAction(Qt.DropAction.CopyAction)
        self.table_game.setAlternatingRowColors(True)
        self.table_game.setSelectionMode(QAbstractItemView.SelectionMode.ExtendedSelection)
        ...
        self.table_game.verticalHeader().setStretchLastSection(False)
        ...
        self.button_edit_game = QPushButton(self.frame)
        self.button_edit_game.setObjectName(u"button_edit_game")

        self.verticalLayout.addWidget(self.button_edit_game)
        ...
        self.table_book.setAcceptDrops(True)
        self.table_book.setDragEnabled(True)
        self.table_book.setDragDropMode(QAbstractItemView.DragDropMode.DropOnly)
        self.table_book.setDefaultDropAction(Qt.DropAction.LinkAction)
        ...
        self.button_edit_book = QPushButton(self.frame_2)
        self.button_edit_book.setObjectName(u"button_edit_book")

        self.verticalLayout_2.addWidget(self.button_edit_book)
        ...
        self.tab_watch.setAcceptDrops(True)
        ...
        self.table_film.setAcceptDrops(True)
        self.table_film.setDragEnabled(True)
        self.table_film.setDragDropMode(QAbstractItemView.DragDropMode.DropOnly)
        self.table_film.setDefaultDropAction(Qt.DropAction.LinkAction)
        ...
        self.button_edit_film = QPushButton(self.frame_3)
        self.button_edit_film.setObjectName(u"button_edit_film")

        self.verticalLayout_3.addWidget(self.button_edit_film)
    ...
    def retranslateUi(self, Backlog):
        ...
        self.button_edit_game.setText(QCoreApplication.translate("Backlog", u"Edit", None))
        ...
        self.button_edit_book.setText(QCoreApplication.translate("Backlog", u"Edit", None))
        ...
        self.button_edit_film.setText(QCoreApplication.translate("Backlog", u"Edit", None))
